...
namespace Scp049rework
{
    public class PluginTranslation : IPluginTranslation
    {
        ...
        public string notEnoughKillsError = "You must kill at least %lateReviveMinKills% before using this command (currently : %current% kill(s)).";
        public string notEnoughRevivesError = "You must revive at least %lateReviveMinRevives% before using this command (currently : %current% revive(s)).";
